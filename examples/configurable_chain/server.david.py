...
azure_openai_api_base = "https://daviwu-ai-2024-aoai395546270926.openai.azure.com/openai/deployments/gpt-35-turbo-16k/"
azure_openai_api_key = "29e2045dc0fd4c8584cd2da656fe5327"
azure_openai_api_version = "2024-02-15-preview"

def createChatOpenAI(temperature: float) -> AzureChatOpenAI:
    # # Use OpenAI
...
model = createChatOpenAI(temperature=0.5).configurable_alternatives(
    ConfigurableField(
        id="llm",
        name="LLM",
        description=(
    ...
    high_temp=createChatOpenAI(temperature=0.9),
    low_temp=createChatOpenAI(temperature=0.0),
