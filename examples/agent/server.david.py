...
azure_openai_api_base = "https://daviwu-ai-2024-aoai395546270926.openai.azure.com/openai/deployments/text-embedding-ada-002/"
...
# # OpenAI API key should only use env var: OPENAI_API_KEY
# llm = AzureChatOpenAI(model="gpt-3.5-turbo", temperature=0, streaming=True)
